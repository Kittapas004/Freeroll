  ...
  const dashboardByRole: Record<string, any[]> = {
    ...
    Farmer: [
      <main key="farmer-dashboard" className="flex flex-row h-full">
        ...
        <div className="hidden lg:block w-1/4 p-4 border-l overflow-y-auto">
          <Card>
          ...
          {/* ส่ง batchId และ userRole ไปยัง NotificationPanel */}
          <NotificationPanel selectedBatchId={batchId ?? undefined} userRole={user.role} />
        </div>
      </main>
    ],
