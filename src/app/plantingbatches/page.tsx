        ...
        try {
            ...
            setPlantingBatches(
                sortedBatches.map((batch: any) => ({
                    ...
                    Farm_Status: batch.Farm?.Farm_Status || 'Unknown',
                    Farm_Name: batch.Farm?.Farm_Name || 'Unknown Farm',
                    Farm_Cultivation_Method: batch.Cultivation_Method || batch.Farm?.Cultivation_Method || 'Unknown',
